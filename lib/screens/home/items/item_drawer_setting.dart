...
class ItemDrawerSetting extends StatelessWidget {
  ItemDrawerSetting(
      {Key? key,
      this.title,
      this.action,
  ...
  final StateHandler _stateHandler = StateHandler('ItemDrawerSetting');
    ...
    return Container(
      child: Row(
        children: [
          ...
          Touchable(
              onTap: () {
                AppThemes().changeThemeMode(!isSelected ? ThemeMode.dark : ThemeMode.light);
