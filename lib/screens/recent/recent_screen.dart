...
class RecentScreen extends GetView<RecentController> {
  static String routeName = '/RecentScreen';
                  ...
                  child: Obx(
                    () => PdfListContent(
                      ...
                      onLongPress: (pdf) {
                        ...
                        pdf.isSelected = true;
                        controller.selected(pdf);
                        Get.find<MainController>().setPageType(PageType.recent);
                      },
                    ),
                  ),
                ),
  ...
  void _onSortClick() {
    showBottomSheetSort(controller.sortBy, controller.sortByType,
        (sortBy, sortByType) {
